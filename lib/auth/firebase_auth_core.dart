...
class FirebaseAuthCore {
  ...
  /// [protorol]: Protocol specification.
  /// [timeout]: Timeout time.
  static Future<User> signInEmailLink(String link,
          {String? locale, Duration timeout = const Duration(seconds: 60)}) =>
  ...
  /// [locale]: Specify the language of the confirmation email.
  /// [timeout]: Timeout time.
  static Future<void> sendSMS(String phoneNumber,
          {String? locale, Duration timeout = const Duration(seconds: 60)}) =>
      _auth.sendSMS(
        phoneNumber,
        locale: locale,
  ...
  /// [locale]: Specify the language of the confirmation email.
  /// [timeout]: Timeout time.
  static Future<User> signInSMS(String smsCode,
          {String? locale, Duration timeout = const Duration(seconds: 60)}) =>
      _auth.signInSMS(
        smsCode,
        locale: locale,
  ...
  /// [locale]: Specify the language of the confirmation email.
  /// [timeout]: Timeout time.
  static Future<User> changePhoneNumber(String smsCode,
          {String? locale, Duration timeout = const Duration(seconds: 60)}) =>
